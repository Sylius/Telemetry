...
final class TelemetryIndexSchemaListener
{
    ...
    {
        try {
            // DBAL 2.x: getSchemaManager(); DBAL 3.x: createSchemaManager() (getSchemaManager deprecated).
        ...
        $key = strtolower(self::INDEX_NAME);

        return isset($dbIndexes[$key]) ? $dbIndexes[$key] : null;
    }
}
