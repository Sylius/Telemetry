...
use Sylius\Telemetry\DTO\Business\OrderMetricsData;
use Sylius\Telemetry\DTO\Business\OrdersBusinessData;
...
final class OrdersBusinessDataProvider implements DataProviderInterface
{
    ...
    // Mirrors Sylius\Component\Core\OrderPaymentStates::STATE_CANCELLED.
    private const ORDER_PAYMENT_STATE_CANCELLED = 'cancelled';
    ...
    private function fetchOrdersData(): array
    {
        ...
        return $this->queryTimeoutRunner->fetchAllAssociative(
            ...
            [
                ...
                'cancelledState' => self::ORDER_PAYMENT_STATE_CANCELLED,
            ]
        );
    }
    ...
    private function emptyDto(): OrdersBusinessData
    {
        return new OrdersBusinessData(
            [],
            [],
